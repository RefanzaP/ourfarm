...
class M_petani extends CI_Model {
     ...
     public function masuk_db()
  {
    ...
    $ql_masuk=$this->db->insert('user', $data_petani);
    return $ql_masuk;
  }
  public function detail_petani($id_user='')
  {
  ...
  return $this->db->where('id_user',$this->input->post('id_user'))->update('user', $dt_up_petani);
  }
